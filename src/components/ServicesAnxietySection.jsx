    ...
    case "brain":
      return (
        <svg viewBox="0 0 48 48" className={className} aria-hidden="true">
          ...
          />
          <path
            d="M24 15v18M19 18c1.5 1 2.6 2.4 3 4.1M29 17c-1.7 1.1-2.8 2.9-3 4.9M18 25h6M24 25h6"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
    ...
    case "shield":
      return (
        <svg viewBox="0 0 48 48" className={className} aria-hidden="true">
          ...
          />
          <path
            d="M24 12l10 4v8c0 6.5-4.2 11.4-10 13.9C18.2 35.4 14 30.5 14 24v-8l10-4z"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinejoin="round"
    ...
    case "thoughts":
      return (
        <svg viewBox="0 0 48 48" className={className} aria-hidden="true">
          ...
          />
          <path
            d="M19 29c-3.5-2-5.3-5.6-4.2-9.1 1.2-3.8 5.4-6.2 9.5-5.2 1.2-1.7 3.3-2.7 5.5-2.4 3.9.5 6.7 4 6.2 7.9 2.1 1.2 3.4 3.5 3.1 6-.5 3.8-4.2 6.6-8.2 6.1-1.2 1.5-3.2 2.4-5.3 2.1-2.3-.3-4.2-1.9-5-4.1z"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.7"
            strokeLinecap="round"
    ...
    case "person":
      return (
        <svg viewBox="0 0 48 48" className={className} aria-hidden="true">
          ...
          />
          <path
            d="M15.5 34c1.8-4.5 6-7 8.5-7s6.7 2.5 8.5 7"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
    ...
    case "cloud":
      return (
        <svg viewBox="0 0 48 48" className={className} aria-hidden="true">
          ...
          />
          <path
            d="M17 28h14a4.5 4.5 0 0 0 .2-9 6.5 6.5 0 0 0-12.4-1.4A5 5 0 0 0 17 28z"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
    ...
    case "heartPulse":
      return (
        <svg viewBox="0 0 48 48" className={className} aria-hidden="true">
          ...
          />
          <path
            d="M24 34s-8-4.8-11-9.3c-2.2-3.2-1.1-7.7 2.8-9.2 2.8-1 5.2.1 6.7 2.3 1.5-2.2 3.9-3.3 6.7-2.3 3.9 1.5 5 6 2.8 9.2C32 29.2 24 34 24 34z"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
          />
          <path
            d="M16.5 24h4l2-3 3.2 6 2.1-3H31.5"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
    ...
    case "hand":
      return (
        <svg viewBox="0 0 48 48" className={className} aria-hidden="true">
          ...
          />
          <path
            d="M18 31V18a2 2 0 1 1 4 0v8-11a2 2 0 1 1 4 0v10-9a2 2 0 1 1 4 0v10-7a2 2 0 1 1 4 0v10c0 5-3.5 7-8 7-5.5 0-8-2.8-8-5z"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
    ...
    case "leaf":
      return (
        <svg viewBox="0 0 48 48" className={className} aria-hidden="true">
          ...
          />
          <path
            d="M23 22c-4-1-7-4.4-8-9 4.7 0 8.2 2.1 9.7 5.8"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
          />
          <path
            d="M25 19.5c1.7-3.5 5.1-5.5 9.7-5.5-.8 4.4-3.7 7.7-8 8.7"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
