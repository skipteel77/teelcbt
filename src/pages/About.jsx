...
export default function About() {
  return (
    <>
      <PageHero eyebrow="About Dr. Teel" title="Meet Dr. Karen Teel">
      ...
      <section className="section white">
        <div className="container">
          <div className="split reverse">
            <div className="copy">
              <h2 className="h2">
                Over a decade of <span className="sage-text">experience</span>{" "}
                treating anxiety
              </h2>
              <p>
                Karen Teel, Ph.D. is a licensed clinical psychologist
                specializing in treating anxiety disorders in children, teens
                ...
                through transitions in their lives, whether it’s changes in
                relationships or life circumstances, or difficulties stemming
                from social isolation. Her goal is to help people by forming a
                strong alliance and providing practical and reasonable advice
                and strategies.
              </p>
              <p>
                Dr. Teel earned her Ph.D. in clinical psychology from Columbia
            ...
            <div className="image-card">
              <img
                src="/assets/about-karen.jpg"
                alt="Dr. Karen Teel at her desk"
              />
            </div>
          </div>
          ...
          <div className="two-col-lists">
            <div>
              ...
              <ul className="list-clean">
                ...
                <li>
                  Ongoing continuing education in evidence-based treatment
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="list-clean">
                <li>New York State Licensed Psychologist</li>
                <li>American Psychological Association (APA)</li>
                <li>
                  Association for Behavioral and Cognitive Therapies (ABCT)
                </li>
                <li>New York State Psychological Association (NYSPA)</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <CTA title="Ready to get started?">
        A brief consultation is a simple way to see whether we’re a good fit.
      </CTA>
    </>
  );
}
