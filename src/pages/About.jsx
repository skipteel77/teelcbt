...
export default function About() {
  return <>
    <PageHero eyebrow="About Dr. Teel" title="Meet Dr. Karen Teel">A collaborative, practical, and compassionate approach to helping people manage their emotions.</PageHero>
    <section className="section white">
      <div className="container">
        <div className="split reverse">
          <div className="copy">
            <h2 className="h2">Over a decade of <span className="sage-text">experience</span> treating anxiety</h2>
