...
const services = [
  ['⌁','Excessive Worry / Obsessional Thinking','Reduce worry and panic, manage physical symptoms, and build confidence in situations that feel difficult.'],
  ['☼','Nervousness','Manage overwhelm, set boundaries, recover from chronic stress, and create healthier balance.'],
  ['◡','High Self-Criticism / Perfectionism','Improve mood, increase motivation, reconnect with what matters, and restore a sense of possibility.'],
  ['◇','Feeling Overwhelmed / Panic / Dread','Navigate change, uncertainty, career shifts, relationships, and new stages of life.'],
  ['♡','Phobias / Fears','Strengthen communication, understand recurring patterns, and build healthier connections.'],
]

const services2 = [
  ['⌁','Compulsive Behaviors','Reduce worry and panic, manage physical symptoms, and build confidence in situations that feel difficult.'],
  ['☼','Tics / Repetitive Movements','Manage overwhelm, set boundaries, recover from chronic stress, and create healthier balance.'],
  ['◡','Freezing / Avoidance','Improve mood, increase motivation, reconnect with what matters, and restore a sense of possibility.'],
  ['◇','Impulsivity','Navigate change, uncertainty, career shifts, relationships, and new stages of life.'],
  ['♡','Physical Panic Symptoms','Strengthen communication, understand recurring patterns, and build healthier connections.'],
]
export default function Services() {
  return <>
    <PageHero eyebrow="Services" title="How I Can Help">Therapy tailored to your concerns, goals, and life circumstances</PageHero>
