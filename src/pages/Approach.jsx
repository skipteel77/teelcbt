...
export default function Approach() {
  return <>
    ...
    <CTA title="Want to see if this approach fits?">A consultation is a reasonable place to start.</CTA>
  </>
}
