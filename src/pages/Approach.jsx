...
import { BrainIcon, HeartIcon, PersonIcon, SearchIcon, SproutIcon, SunIcon } from '../components/Icons'
...
export default function Approach() {
  return <>
    ...
    <section className="section white"><div className="container cbt-top"><div><div className="eyebrow">Cognitive Behavioral Therapy</div><h2 className="h2">Thoughts, feelings, and behaviors are connected.</h2><p className="lead">CBT gives us a practical framework for noticing those connections and experimenting with new ways to respond. The work is active, transparent, and tailored to your goals.</p></div><div className="cbt-loop"><div className="loop-node"><div className="loop-circle"><BrainIcon/></div><span>Thoughts</span></div><div className="swap">↔</div><div className="loop-node"><div className="loop-circle"><HeartIcon/></div><span>Feelings</span></div><div className="swap">↔</div><div className="loop-node"><div className="loop-circle"><PersonIcon/></div><span>Behaviors</span></div></div></div>
