...
export default function Contact() {
  ...
  return <>
    ...
    <section className="cta"><div className="container"><h2 className="h2">Finding the right therapist matters.</h2><p>Once the scheduling workflow is finalized, this area can point directly to a secure consultation booking page.</p></div></section>
  </>
}
